...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php echo $html->css('custom-theme/jquery-ui-1.7.1.custom'); ?>
...
<div id="navigation-block">
    ...
    <ul>
    <li class="ui-icon ui-icon-carat-1-n">Test One</li>
    <li class="ui-icon ui-icon-carat-1-n">Test Two</li>
    <li class="ui-icon ui-icon-carat-1-n">Test Three</li>
    </ul>
...
<?php echo $form->end(); ?>
		...
		<li class="ui-state-default ui-corner-all" title=".ui-icon-carat-1-n"><span class="ui-icon ui-icon-carat-1-n"></span>Cool Beans </li>
