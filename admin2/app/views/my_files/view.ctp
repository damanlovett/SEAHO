...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit MyFile', true), array('action'=>'edit', $myFile['MyFile']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete MyFile', true), array('action'=>'delete', $myFile['MyFile']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $myFile['MyFile']['id'])); ?> </li>
