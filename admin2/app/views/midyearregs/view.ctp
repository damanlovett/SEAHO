...
<h2><?php  __('Registration: '.$midyearreg['Midyearreg']['first_name'].' '.$midyearreg['Midyearreg']['last_name']);?></h2>
...
<div class="actions">
	<ul>
		...
		<li><?php // echo $html->link(__('Delete Midyearreg', true), array('action'=>'delete', $midyearreg['Midyearreg']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $midyearreg['Midyearreg']['first_name'])); ?> </li>
