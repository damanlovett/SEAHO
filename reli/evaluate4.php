...
<?php require_once('../includefiles/header.inc.php'); ?>
  ...
  <tr>
    ...
    <td width="582" valign="top" id="contentmain"><!-- InstanceBeginEditable name="mainContent" -->
      ...
      <p> Thanks so much for taking the time to provide feedback on your RELI experiences! Honest participant evaluation helps us to make the Institute better and better each year!&nbsp; </p>
