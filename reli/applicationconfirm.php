...
<?php require_once('../includefiles/header.inc.php'); ?>
  ...
  <tr>
    ...
    <td width="582" valign="top" id="contentmain"><!-- InstanceBeginEditable name="mainContent" -->
      <p><strong>RELI Form Confirmation</strong></p>
      <p>Your email was sent to the RELI committee.    If you have any questions about your application please send and email to <a href="mailto:reli@seaho.org">reli@seaho.org</a></p>
      <p>
    <!-- InstanceEndEditable --></td>
  </tr>
