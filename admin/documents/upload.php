...
mysql_select_db($database_SEAHOdocuments, $SEAHOdocuments);
$query_rsAttachments = "SELECT id, doc_id, categories, cat_id, title, `file` FROM attachments WHERE categories = 'seaho_reports'";
...
<title>SEAHO Report Uploads</title>
<!-- InstanceEndEditable -->
...
<div id="mainContent">
  <div id="mainText">
    <h2><!-- InstanceBeginEditable name="PageTitle" -->
      ...
      <span class="pageHeadVotingAdmin">SEAHO Report Uploads</span>
  ...
  <tr>
    <td colspan="3" class="tableTop">      <input name="Button" type="button" value="Refresh List" />    </td>
    </tr>
  <tr>
    <th nowrap="nowrap">Report Title</th>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="../../documents/deleteseahoreport.php?recordID=<?php echo $row_rsAttachments['doc_id']; ?>&amp;document=<?php echo $row_rsAttachments['file']; ?>"><img src="../../programs/images/imgAdminDelete.gif" alt="Delete" width="14" height="14" border="0" /></a></td>
    </tr>
