...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  $updateSQL = sprintf("UPDATE state_editors SET `column`=%s, `order`=%s, `state`=%s, first_name=%s, last_name=%s, institution=%s, email=%s WHERE editor_id=%s",
                       ...
                       GetSQLValueString($_POST['editor_id'], "text"));
...
mysql_select_db($database_Directory, $Directory);
$query_rsUpdate = sprintf("SELECT * FROM state_editors WHERE editor_id = %s", GetSQLValueString($colname_rsUpdate, "text"));
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="update" id="update">
        <table width="150" border="0" align="left" cellpadding="5" cellspacing="0" class="detailspopup">
          <tr align="left" valign="middle">
            ...
            <td><label>
              <input name="first_name" type="text" id="first_name" value="<?php echo $row_rsUpdate['first_name']; ?>" />
            </label></td>
          </tr>
          <tr align="left" valign="middle">
            <td nowrap="nowrap"> <strong>Last Name</strong></td>
            <td><label>
              <input name="last_name" type="text" id="last_name" value="<?php echo $row_rsUpdate['last_name']; ?>" />
            </label></td>
          </tr>
          <tr align="left" valign="middle">
            <td nowrap="nowrap"><div align="right"><strong>State</strong></div></td>
            <td><label>
              <input name="state" type="text" id="state" value="<?php echo $row_rsUpdate['state']; ?>" />
            </label></td>
          </tr>
          <tr align="left" valign="middle">
            <td nowrap="nowrap"><strong>Institution</strong></td>
            <td><label>
              <input name="institution" type="text" id="institution" value="<?php echo $row_rsUpdate['institution']; ?>" size="45" />
            </label></td>
          </tr>
          <tr align="left" valign="middle">
          ...
          <tr align="left" valign="middle">
            <td nowrap="nowrap"><div align="right">
              <input name="editor_id" type="hidden" id="editor_id" value="<?php echo $row_rsUpdate['editor_id']; ?>" />
            </div></td>
