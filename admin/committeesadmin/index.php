...
mysql_select_db($database_Directory, $Directory);
$query_rsGovern1 = "SELECT id, position_id, user_id, `position`, `group`, votes, `column`, `order`, team_positions.`delete` FROM team_positions WHERE `column` = 1 AND `group` = 'Governing Council' AND `delete`=0 ORDER BY `order` ASC";
...
mysql_select_db($database_Directory, $Directory);
$query_rsGovern2 = "SELECT id, position_id, user_id, `position`, `group`, votes, `column`, `order`, team_positions.`delete` FROM team_positions WHERE `column` = 2 AND `group` = 'Governing Council' AND `delete`=0 ORDER BY `order` ASC";
...
<div id="mainContent">
  <div id="mainText">
    <h2><!-- InstanceBeginEditable name="PageTitle" --><span class="pageHeadUserAdmin">Governing Council Manager</span> <!-- InstanceEndEditable --></h2>
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="addCouncil" id="addCouncil">
        <table border="0" cellpadding="3" cellspacing="0">
          <tr align="left" valign="middle">
            <td nowrap="nowrap"><div align="right"><strong>Council Title</strong></div></td>
          ...
          <tr align="left" valign="middle">
            ...
            <td>&nbsp;</td>
            <td nowrap="nowrap">&nbsp;</td>
            <td colspan="3"><input name="button" type="submit" class="submitButton" id="button" value="Add Council" /></td>
            <td>&nbsp;</td>
          </tr>
        </table>
        <input name="position_id" type="hidden" id="position_id" value="<?php echo create_guid();?>" />
        <input name="group" type="hidden" id="group" value="Governing Council" />
