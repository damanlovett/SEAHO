...
$query_rsUsers = "SELECT id, user_id, first_name, last_name, middle, `position`, title, address, city, `state`, zip, school, email, password, `access`, `delete` FROM users WHERE `delete` = 0";
...
$xmlExportObj->addColumn("middle", "middle");
...
$xmlExportObj->addColumn("state", "state");
$xmlExportObj->addColumn("zip", "zip");
$xmlExportObj->addColumn("school", "school");
$xmlExportObj->addColumn("email", "email");
$xmlExportObj->addColumn("password", "password");
$xmlExportObj->addColumn("access", "access");
$xmlExportObj->addColumn("delete", "delete");
