...
<div id="mainContent">
  <div id="mainText">
    <h2><!-- InstanceBeginEditable name="PageTitle" --><span class="pageHeadstate"><?php echo substr($row_rsStateInfo['position'],0,-4); ?> Pages</span> <!-- InstanceEndEditable --></h2>
    ...
    <table border="0" cellpadding="5" cellspacing="0" class="tableborder">
      ...
      <?php do { ?>
        <tr  class="tableRowColor">
          ...
          <td><a href="printreport.php?recordID=<?php echo $row_rsStatePages['page_id']; ?>" target="_blank"><img src="../images/printer-pearl.gif" alt="Print" width="14" height="14" /></a></td>
