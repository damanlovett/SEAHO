...
<!-- InstanceEndEditable --><img src="../../../images/dropshadowlogo.jpg" alt="Seaho Logo" /></td>
    <td width="582" valign="top" id="contentmain"><!-- InstanceBeginEditable name="mainContent" -->
      ...
      <p>Thank you for creating a new account. Your account information has been emailed to you. You may now use the conference manager by going to the <a href="../index.php">Login Page</a> and entering your information.</p>
      <!-- InstanceEndEditable --></td>
  </tr>
