...
<!-- InstanceEndEditable --><img src="../../../images/dropshadowlogo.jpg" alt="Seaho Logo" /></td>
    <td width="582" valign="top" id="contentmain"><!-- InstanceBeginEditable name="mainContent" -->
      <h3><strong> Duplicate Account</strong></h3>
      <p>There is currently an account with this email address. If you have lost your password please use the form below and your password will be mailed to you within 48 hours.</p>
  ...
  <tr>
    <td><div id="loginbox">
      <div>
            ...
            <form id="login" name="login" method="post" action="/registration/delegate/account/duplicateaccount.php">
          <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            <tbody>
              <tr>

              <td nowrap="nowrap"><label for="textfield">Email Address:</label></td>
              <td><input name="email" type="text" class="smallbox" id="email" value="<?php echo $_SESSION['emaill'];?>" size="50"></td>
            </tr>
