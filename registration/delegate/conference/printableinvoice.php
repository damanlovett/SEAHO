...
mysql_select_db($database_CMS, $CMS);
$query_rsTransactions = sprintf("SELECT * FROM delegate_transactions WHERE conference_id = %s AND delegate_transactions.delegate_id = %s", GetSQLValueString($colname_rsTransactions, "text"),GetSQLValueString($colname2_rsTransactions, "text"));
...
<table width="100%" align="center" cellpadding="3">
  <tr class="hidePrint">
    ...
    <td valign="top"><input name="button" type="submit" id="button" onclick="MM_goToURL('parent','invoice.php?conferenceID=<?php echo $row_rsRegistration['conference_id']; ?>');return document.MM_returnValue" value="Return To Menu" /></td>
    <td valign="top">&nbsp;</td>
  </tr>
  <tr>
