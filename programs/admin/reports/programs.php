...
//$query_rsPrograms = "SELECT * FROM callforprograms";
...
mysql_select_db($database_Programming, $Programming);
$query_rsPrograms = "SELECT * INTO OUTFILE '/home/user/myTable.csv' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' FROM myTable";

//$query_rsPrograms = "SELECT id, ProgramTitle, FirstName, LastName, MiddleInitial, Title, Institution, Address, City, `State`, Zip FROM callforprograms";
$rsPrograms = mysql_query($query_rsPrograms, $Programming) or die(mysql_error());
$row_rsPrograms = mysql_fetch_assoc($rsPrograms);
$totalRows_rsPrograms = mysql_num_rows($rsPrograms);
