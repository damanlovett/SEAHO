...
$query_rsPrograms = "SELECT * FROM callforprograms WHERE Status = 'Accepted' ORDER BY id ASC";
...
$csv_output .= ",".str_replace(",", "", $row_rsPrograms['targetAudience1']." ".$row_rsPrograms['targetAudience2']." ".$row_rsPrograms['targetAudience3']." ".$row_rsPrograms['targetAudience4']." ".$row_rsPrograms['targetAudience5']." ".$row_rsPrograms['targetAudience6']." ".$row_rsPrograms['targetAudience7'])."";
...
header("Content-disposition:  attachment; filename=ProgramsAccepted.csv");
echo $csv_output;
