...
$query_rsPrograms = "SELECT * FROM callforprograms WHERE Status = 'Alternate' ORDER BY id ASC";
...
header("Content-disposition:  attachment; filename=ProgramsAlternates.csv");
echo $csv_output;
