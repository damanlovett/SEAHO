...
$query_rsPrograms = "SELECT * FROM callforprograms ORDER BY id ASC";
...
header("Content-disposition:  attachment; filename=ProgramsAll.csv");
echo $csv_output;
