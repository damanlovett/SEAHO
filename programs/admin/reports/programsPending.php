...
$query_rsPrograms = "SELECT * FROM callforprograms WHERE Status = 'Pending Presenter' ORDER BY id ASC";
...
header("Content-disposition:  attachment; filename=ProgramsPending.csv");
echo $csv_output;
