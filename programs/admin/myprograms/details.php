...
<div class="detailspopup2">
 ...
 Your vote has been recorded as <?php echo $_POST['vote'];?></span><?php }?></p>
    ...
    <p><?php echo $row_rsReviewers['reviewID']; ?></p>
    <hr />
	<?php if((!isset($_GET['vote'])) && ($row_rsReviewers['read']!=1)){?>
  <p>
    <label>
    <input name="vote" type="submit" id="vote" onclick="MM_goToURL('parent','details.php?recordID=<?php echo $_POST['reviewID']; ?>&amp;programID=<?php echo $row_rsProgramDetails['id']; ?>&amp;vote=yes');return document.MM_returnValue" value="Vote on this program" />
    </label>
  </p>
	<?php } else {?>
