...
$query_rsProgramlist = sprintf("SELECT id, ProgramTitle, ProgramNumber, `session`, location, FirstName, LastName, ProgramDescription FROM callforprograms WHERE LastName LIKE CONCAT(%s, '%%') AND callforprograms.Status = 'Accepted'", GetSQLValueString($colname_rsProgramlist, "text"));
