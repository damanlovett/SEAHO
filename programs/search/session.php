...
$query_rsProgramlist = sprintf("SELECT ProgramTitle, `session`, location, programTime, FirstName, SessionType, ProgramDescription, callforprograms.Status, callforprograms.LastName, callforprograms.id FROM callforprograms WHERE `session` = %s AND callforprograms.Status = 'Accepted'", GetSQLValueString($colname_rsProgramlist, "text"));
...
<h2>  <?php if(!isset($_POST['search'])) { echo "All Programs"; } else { echo "Search Results for Session ".$_POST['search']." ";}?>
</h2>
    ...
    <tr>
      <td bgcolor="#FFFFFF"><div class="ProgramTitles">
        ...
        <p><strong>Description:</strong><br>
          <?php echo substr(($row_rsProgramlist['ProgramDescription']),0,200); ?> . . . <br> 
          [ <a href="../programdetails.php?recordID=<?php echo $row_rsProgramlist['id']; ?>">Full Description</a> ]</p></td>
      </tr>
