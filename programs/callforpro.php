...
<div align="center"><img src="../images/logo2011.jpg" alt="Conference Logo" width="146" height="91" /><br />
</div>
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><div align="left">Check only the equipment you definitely  need and can not provide yourself.<br />
        An LCD projector and/or projection screen will be available in <br />
        every room.</div></td>
    </tr>
    <tr valign="baseline">
...
:</strong></td>
      <td><input type="checkbox" name="EquipmentNeeds" value="Speakers" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>
<!--        <label>Overhead Transparency Projector</label>:-->
      </strong></td>
      <td><input type="hidden" name="EquipmentNeeds2" value="Overhead Transparency Projector" /></td>
    </tr>
    <tr valign="baseline">
